...
1. Clone this repository or download the *linkedin_articles_scraper.py* file.
...
5. The script will scrape the articles and save them to a CSV file named *articles.csv* in the same directory.
